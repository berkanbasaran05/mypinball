...
const Drops = () => {
  ...
  const dropData = [
    {
      img: "img/drops/1.jpg",
      title: "Mypinball #4588",
    },
    {
      img: "img/drops/2.jpg",
      title: "Mypinball #4587",
    },
    {
      img: "img/drops/3.jpg",
      title: "Mypinball #4586",
    },
    {
      img: "img/drops/4.jpg",
      title: "Mypinball #4585",
    },
    {
      img: "img/drops/5.jpg",
      title: "Mypinball #4584",
    },
    {
      img: "img/drops/6.jpg",
      title: "Mypinball #4583",
    },
  ];
      ...
      <section id="drop">
        <div className="container">
          ...
          <div className="neoh_fn_title">
            <h3 className="fn_title">Unsere Produkte</h3>
            <div className="line">
              <span />
            </div>
          </div>
            ...
            <ul>
              <li>
                <div
                  ...
                  data-modal-title="Mypinball #4588"
                ...
                >
                  ...
                  <div className="title_holder">
                    <h3 className="fn_title">
                      <a onClick={() => onClick(1)}>Mypinball #4588</a>
                    </h3>
                  </div>
                </div>
              </li>
              <li>
                <div
                  ...
                  data-modal-title="Mypinball #4587"
                  data-modal-description="Suspendisse eu velit est. Cras nec vestibulum quam. Donec tincidunt purus nec enim tincidunt, sit amet facilisis massa laoreet. Integer mollis nec sapien eu lacinia."
                  data-modal-opensea-url=""
                  data-modal-discord-url="#"
                >
                  ...
                  <div className="title_holder">
                    <h3 className="fn_title">
                      <a onClick={() => onClick(2)}>Mypinball #4587</a>
                    </h3>
                  </div>
                </div>
              </li>
              <li>
                <div
                  ...
                  data-modal-title="Mypinball #4586"
                  data-modal-description="Suspendisse eu velit est. Cras nec vestibulum quam. Donec tincidunt purus nec enim tincidunt, sit amet facilisis massa laoreet. Integer mollis nec sapien eu lacinia."
                  data-modal-opensea-url="#"
                  data-modal-discord-url=""
                >
                  ...
                  <div className="title_holder">
                    <h3 className="fn_title">
                      <a onClick={() => onClick(3)}>Mypinball #4586</a>
                    </h3>
                  </div>
                </div>
              </li>
              <li>
                <div
                  ...
                  data-modal-title="Mypinball #4585"
                  data-modal-description="Suspendisse eu velit est. Cras nec vestibulum quam. Donec tincidunt purus nec enim tincidunt, sit amet facilisis massa laoreet. Integer mollis nec sapien eu lacinia."
                  data-modal-opensea-url="#"
                  data-modal-discord-url=""
                >
                  ...
                  <div className="title_holder">
                    <h3 className="fn_title">
                      <a onClick={() => onClick(4)}>Mypinball #4585</a>
                    </h3>
                  </div>
                </div>
              </li>
              <li>
                <div
                  ...
                  data-modal-title="Mypinball #4584"
                  data-modal-description="Suspendisse eu velit est. Cras nec vestibulum quam. Donec tincidunt purus nec enim tincidunt, sit amet facilisis massa laoreet. Integer mollis nec sapien eu lacinia."
                  data-modal-opensea-url="#"
                  data-modal-discord-url=""
                >
                  ...
                  <div className="title_holder">
                    <h3 className="fn_title">
                      <a onClick={() => onClick(5)}>Mypinball #4584</a>
                    </h3>
                  </div>
                </div>
              </li>
              <li>
                <div
                  ...
                  data-modal-title="Mypinball #4583"
                  data-modal-description="Suspendisse eu velit est. Cras nec vestibulum quam. Donec tincidunt purus nec enim tincidunt, sit amet facilisis massa laoreet. Integer mollis nec sapien eu lacinia."
                  data-modal-opensea-url="#"
                  data-modal-discord-url=""
                >
                  ...
                  <div className="title_holder">
                    <h3 className="fn_title">
                      <a onClick={() => onClick(6)}>Mypinball #4583</a>
                    </h3>
                  </div>
                </div>
              </li>
